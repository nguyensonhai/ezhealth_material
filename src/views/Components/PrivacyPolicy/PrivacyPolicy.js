...
export default function PrivacyPolicy() {
  return (
    <div style={{ backgroundColor: "white", padding: 20, margin: 0 }}>
      <strong>Privacy Policy</strong>{" "}
      <p>
        Ez Ratech built the Ez Health app as a Free app. This SERVICE is
        provided by Ez Ratech at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Ez Health unless otherwise
      ...
      <p>
        The application will use the email and avatar image provided by the user
        to serve to increase the application experience such as displaying the
        avatar for others to see and using the email as an account that can be
        logged in, the user can delete account and any personal information
        provided by the delete account feature in the application, we are
        committed not to collect personal data of the user.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        ...
        hesitate to contact me at nguyensonhai.dev@gmail.com.
      </p>{" "}
    </div>
  );
}
